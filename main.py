...
# arima(serbia_inflation_df, serbia, (2, 1, 2))
# arimax(serbia_inflation_df, serbia_exog_df, serbia, (2, 1, 2))
# sarima(serbia_inflation_df, serbia, (7, 1, 3), (7, 1, 3, 12))
# sarimax(serbia_inflation_df, serbia_exog_df, serbia, (7, 0, 3), (7, 0, 3, 12))
...
arima(bh_inflation_df, bosnia, (7, 0, 4))
arimax(bh_inflation_df, bh_exog_df, bosnia, (4, 0, 2))
sarima(bh_inflation_df, bosnia, (7, 0, 4), (6, 0, 3, 12))
sarimax(bh_inflation_df, bh_exog_df, bosnia, (7, 0, 2), (2, 0, 1, 12))
